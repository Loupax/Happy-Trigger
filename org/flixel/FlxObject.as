package org.flixel
{
	...
	public class FlxObject extends FlxRect
	{
		...
		/**
		 *Flag for control of the collidions in general 
		 */
		public var _canCollide:Boolean;
		/**
		...
		/**
		 * Sets all collide flags to the same value
		 */
		public function set canCollide(Collides:Boolean):void
		{
			collideLeft = collideRight = collideTop = collideBottom = _canCollide=Collides;
		}
		
		/**
		 * If any collision flag is true, returns true, else returns false
		 */
