package org.flixel
{
	...
	public class FlxGroup extends FlxObject
	{
		...
		/**
		 * Call this function to retreive the LAST available object with exists == false in the group.
		 * This can be used when recycling, if you need to kill the oldest object on screen to make room for a new
		 * one...
		 * Added by Kostas Loupasakis
		 *
		 * @return A <code>FlxObject</code> currently flagged as not existing.
		 */
		public function getLastAvail():FlxObject {
			var o:FlxObject;
			var ml:uint = members.length;
			while(0 < ml)
			{
				o = members[ml--] as FlxObject;
				if((o != null) && !o.exists)
					return o;
			}
			return null;
		...
		public function getLastExtant():FlxObject
		{
			var o:FlxObject;
			var ml:uint = members.length;
			while(0 < ml)
